...
public class AboutUs extends JFrame{
    ...
    public AboutUs() {
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/ditlogo.png"));
        ...
        JLabel l6 = new JLabel("Developed By : Utkarsh Rana");
        l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
        l6.setBounds(70, 198, 600, 35);
        contentPane.add(l6);

        JLabel l7 = new JLabel("Contact Number: +919610728818");
        l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
        l7.setBounds(70, 260, 600, 34);
        contentPane.add(l7);

        JLabel l8 = new JLabel("Contact : utkarshrana9610@gmail.com");
